...
public class CopyAll02 {
    public static void main(String[] args) {
        // 拷贝源
        File srcFile = new File("/Users/lilei/IdeaProjects/Learning/src/Review/Array/BinarySearch.java");
        // 拷贝目标
        File destFile = new File("/Users/lilei/IdeaProjects/Learning/src/Review/Loop");
        // 调用方法拷贝
    ...
    private static void copyDir(File srcFile, File destFile) {
        if(srcFile.isFile()) {
            ...
            try {
                ...
                String path = (destFile.getAbsolutePath().endsWith("\\") ? destFile.getAbsolutePath() : destFile.getAbsolutePath() + "\\")  + srcFile.getAbsolutePath().substring(7);
